...
export class RenewTheApprovalForProductResponse {
  @ApiResponseProperty({ type: String })
  message: string;
...
export class GetAllProductsByManufacturerIdResponse {
  @ApiResponseProperty({ type: String })
  message: string;
...
export class GetAllProductWithCategoryImageByCategoryIdResponse {
  @ApiResponseProperty({ type: String })
  message: string;
...
export class GetAllProductWithCategoryImageBySearchResponse {
  @ApiResponseProperty({ type: String })
  message: string;
...
export class GetAllProductLookaheadWithCategoryImageBySearchResponse {
  @ApiResponseProperty({ type: String })
  message: string;
